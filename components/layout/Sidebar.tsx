...
//  },
  ...
  {
    name: 'ขอใช้คอมพิวเตอร์',
    href: '/user/computer-booking',
    roles: ['user'],
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 5h14a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2z" />
      </svg>
    ),
  },
  {
    name: 'ประวัติการขอใช้งาน',
...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-64 bg-blue-800 min-h-screen flex flex-col sticky top-0 h-screen overflow-y-auto">
      <div className="p-6 border-b border-blue-700">
        ...
        <p className="text-blue-200 text-sm mt-1">
          {loading ? 'กำลังโหลด...' : role === 'admin' ? 'ผู้ดูแลระบบ' : 'ผู้ใช้งาน'}
        </p>
      </div>
