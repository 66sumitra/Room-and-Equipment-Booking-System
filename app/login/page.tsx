...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-teal-50 to-green-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* 1. ส่วนตกแต่งพื้นหลัง (Animation Blob) */}
      ...
      {/* 2. ส่วนเนื้อหาหลัก (เรียกใช้ LoginForm) */}
      <div className="relative z-10 w-full max-w-md"> {/* เพิ่ม max-w-md เพื่อให้ฟอร์มไม่กว้างเกินไป */}
        <LoginForm />
      </div>
